...
int main() {
  triangulation::test_square();
  triangulation::test_rotated_square();
  triangulation::test_polygon_no_holes();
  triangulation::test_square_with_hole();
  triangulation::test_with_two_holes();
}
